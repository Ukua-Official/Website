        ...
        <div class='container'>
            ...
            <div class='text-left'>
                <p>
                    ...
                    <br/>
                    <br/>
                    <span class='page-subtitle strong'>Article 1 - Mentions légale</span>
                    <br/>
                    <br/>
                    <span class='font-underline'>1.1 - Site (ci-après « le site ») :</span>
                    <br/>
                    <br/>
                    Ukua
                    <br/>
                    Adresse mail de contact : <a href='mailto:contact@ukua.com'>contact@ukua.com</a>
                    <br/>
                    Adresse mail de partenaire : <a href='mailto:partner@ukua.com'>partner@ukua.com</a>
                    <br/>
                    Adresse mail de support : <a href='mailto:support@ukua.com'>support@ukua.com</a>
                    <br/>
                    <br/>
                    <span class='font-underline'>1.2 - Éditeur (ci-après « l'éditeur ») :</span>
                    <br/>
                    <br/>
                    Wesley LEVASSEUR
                    <br/>
                    Domicilié : 58 RUE PARMENTIER, 59620 AULNOYE-AYMERIES
                    <br/>
                    N° de téléphone : <a href='tel:+33698594180'>06 98 59 41 80</a>
                    <br/>
                    Adresse mail : <a href='mailto:mailpro.levasseur@icloud.com'>mailpro.levasseur@icloud.com</a>
                    <br/>
                    <br/>
                    <span class='font-underline'>1.3 - Hébergeur (ci-après « l'hébergeur ») :</span>
                    <br/>
                    <br/>
                    Ukua est hébergé par <a href='https://www.ouiheberg.com/'>Ouiheberg</a>, dont le siège social est
                    situé 22 RUE DU MUSCAT, 30470 AIMARGUES.
                    <br/>
                    <br/>
                    <span class='font-underline'>1.4 - Délégué à la protection des données [<a
                            href='https://www.cnil.fr/fr/le-delegue-la-protection-des-donnees-dpo'>DPO</a>] (ci après « le délégué à la protection des données ») :</span>
                    <br/>
                    <br/>
                    Un délégué à la protection des données susnommé Wesley LEVASSEUR est à votre disposition pour toute
                    question relative à la protection de vos données personnelles.
                    <br/>
                    <br/>
                    <span class='page-subtitle strong'>Article 2 - Accès au site</span>
                    <br/>
                    <br/>
                    L'accès au site et son utilisation sont réservés à un usage strictement personnel.
                    <br/>
                    Vous vous engagez à ne pas utiliser ce site et les informations ou données qui y figurent à des fins
                    commerciales, politiques, publicitaires et pour toute forme de sollicitation commerciale et
                    notamment l'envoi de courriers électroniques non sollicités.
                    <br/>
                    <br/>
                    <span class='page-subtitle strong'>Article 3 - Contenu du site</span>
                    <br/>
                    <br/>
                    ...
                    propriété pleine et entière de l'éditeur ou de ses partenaires.
                    <br/>
                    ...
                    écrit de l'éditeur, sont strictement interdites. Le fait pour l'éditeur de ne pas engager de
                    ...
                    <br/>
                    <br/>
                    <span class='page-subtitle strong'>Article 4 - Gestion du site</span>
                    <br/>
                    <br/>
                    <span class='font-underline'>Pour la bonne gestion du site, l'éditeur pourra à tout moment :</span>
                    <br/>
                    <br/>
                    <span class='m-2 p-2'>
                        <i class='fa fa-chevron-right'></i>
                        &nbsp;Suspendre, interrompre ou limiter l'accès à tout ou partiedusite, réserver l'accès au site, ou à certaines parties du site, à une catégorie déterminée d'internautes.
                    </span>
                    <br/>
                    <span class='m-2 p-2'>
                        <i class='fa fa-chevron-right'></i>
                    ...
                    <br/>
                    <br/>
                    <span class='page-subtitle strong'>Article 5 - Responsabilités</span>
                    <br/>
                    <br/>
                    ...
                    <br/>
                    <br/>
                    <span class='font-underline'>L'éditeur ne pourra être tenu responsable en cas de poursuites judiciaires à votre encontre :</span>
                    <br/>
                    <br/>
                    <span class='m-2 p-2'>
                        <i class='fa fa-chevron-right'></i>
                    ...
                    <br/>
                    <br/>
                    <span class='page-subtitle strong'>Article 6 - Liens hypertextes</span>
                    <br/>
                    <br/>
                    ...
                    <br/>
                    <br/>
                    <span class='page-subtitle strong'>Article 7 - Collecte et protection des données</span>
                    <br/>
                    <br/>
                    Vos données sont collectées par l'entreprise individuelle <strong>Ukua</strong>.
                    <br/>
                    ...
                    <br/>
                    <br/>
                    <span class='font-underline'>Les données personnelles collectées sont les suivantes :</span>
                    <br/>
                    <br/>
                    <span class='m-2 p-2'>
                        <i class='fa fa-chevron-right'></i>
                    ...
                    <br/>
                    <br/>
                    Le délégué à la protection des données susnommée Wesley LEVASSEUR est à votre disposition pour toute
                    question relative à la protection de vos données personnelles.
                    <br/>
                    <br/>
                    <span class='page-subtitle strong'>Article 8 - Droit d’accès, de rectification et de déréférencement de vos données</span>
                    <br/>
                    <br/>
                    <span class='font-underline'>Le droit d’accès</span> : ils peuvent exercer leur droit d'accès, pour
                    connaître les données personnelles
                    les concernant, en écrivant à l'adresse électronique ci-dessous mentionnée. Dans ce cas, avant la
                    ...
                    <br/>
                    <br/>
                    <span class='font-underline'>Le droit de rectification</span> : si les données à caractère personnel
                    détenues par la Plateforme sont
                    inexactes, ils peuvent demander la mise à jour des informations.
                    <br/>
                    <br/>
                    <span class='font-underline'>Le droit de suppression des données</span> : les utilisateurs peuvent
                    demander la suppression de leurs
                    données à caractère personnel, conformément aux lois applicables en matière de protection des
                    données.
                    <br/>
                    <br/>
                    <span class='font-underline'>Le droit à la limitation du traitement</span> : les utilisateurs
                    peuvent de demander à la Plateforme de
                    limiter le traitement des données personnelles conformément aux hypothèses prévues par le RGPD.
                    <br/>
                    <br/>
                    <span class='font-underline'>Le droit de s’opposer au traitement des données</span> : les
                    utilisateurs peuvent s’opposer à ce que leurs
                    données soient traitées conformément aux hypothèses prévues par le RGPD.
                    <br/>
                    <br/>
                    <span class='font-underline'>Le droit à la portabilité</span> : ils peuvent réclamer que la
                    Plateforme leur remette les données
                    personnelles qu'ils ont fournies pour les transmettre à une nouvelle Plateforme.
                    <br/>
                    <br/>
                    <span class='font-underline'>En application de la réglementation applicable aux données à caractère personnel, les utilisateurs disposent des droits suivants :</span>
                    <br/>
                    <br/>
                    <span class='m-2 p-2'>
                        <i class='fa fa-chevron-right'></i>
                    ...
                    <br/>
                    <br/>
                    <span class='font-underline'>Vous pouvez exercer ce droit en nous contactant :</span>
                    <br/>
                    <br/>
                    <span class='m-2 p-2'>
                        <i class='fa fa-chevron-right'></i>
                        &nbsp;Par voie postale au 58 RUE PARMENTIER 59620 AULNOYE-AYMERIES.
                    </span>
                    <br/>
                    <span class='m-2 p-2'>
                        <i class='fa fa-chevron-right'></i>
                        &nbsp;Par l'adresse mail de l'éditeur à l'addresse suivante <a
                            href='mailto:mailpro.levasseur@icloud.com'>mailpro.levasseur@icloud.com</a>
                    </span>
                    <br/>
                    <span class='m-2 p-2'>
                        <i class='fa fa-chevron-right'></i>
                        &nbsp;par l'adresse mail de support du site à l'addresse suivante <a
                            href='mailto:support@ukua.com'>support@ukua.com</a>
                    </span>
                    <br/>
                    <br/>
                    Le délégué à la protection des données susnommée Wesley LEVASSEUR est à votre disposition pour toute
                    ...
                    signé et faire mention de l’adresse à laquelle l'éditeur pourra contacter le demandeur.
                    <br/>
                    La réponse sera adressée dans le mois suivant la réception de la demande.
                    <br/>
                    Ce délai d'un mois peut être prolongé de deux mois si la complexité de la demande et/ou le nombre de
                    demandes l'exigent.
                    <br/>
                    De plus, et depuis la loi n°2016-1321 du 7 octobre 2016, les personnes qui le souhaitent, ont la
                    possibilité d’organiser le sort de leurs données après leur décès.
                    <br/>
                    ...
                    <br/>
                    <br/>
                    <span class='page-subtitle strong'>Article 9 - Utilisation des données</span>
                    <br/>
                    <br/>
                    Les données personnelles collectées auprès des utilisateurs ont pour objectif la mise à disposition
                    des services de la Plateforme, leur amélioration et le maintien d'un environnement sécurisé.
                    <br/>
                    La base légale des traitements est l’exécution du contrat entre l’utilisateur et la Plateforme.
                    <br/>
                    <span class='font-underline'>Plus précisément, les utilisations sont les suivantes :</span>
                    <br/>
                    <br/>
                    <span class='m-2 p-2'>
                        <i class='fa fa-chevron-right'></i>
                    ...
                    <br/>
                    <br/>
                    <span class='page-subtitle strong'>Article 10 - Politique de conservation des données</span>
                    <br/>
                    <br/>
                    ...
                    conditions, nous pouvons également conserver certaines de vos informations si nécessaire, même après
                    que vous ayez fermé votre compte ou que nous n'ayons plus besoin pour vous fournir nos services.
                    <br/>
                    <br/>
                    <span class='page-subtitle strong'>Article 11- Partage des données personnelles avec des tiers</span>
                    <br/>
                    <br/>
                    <span class='font-underline'>Les données personnelles peuvent être partagées avec des sociétés tierces exclusivement dans l’Union européenne, dans les cas suivants :</span>
                    <br/>
                    <br/>
                    <span class='m-2 p-2'>
                        <i class='fa fa-chevron-right'></i>
                        &nbsp;Lorsque l'utilisateur publie, dans les zones de commentaires libres de la Plateforme,
                    ...
                    <span style='text-decoration: line-through'>
                        <br/>
                        <br/>
                        <span class='page-subtitle strong'>Article 12 - Offres commerciales</span>
                        <br/>
                        <br/>
                        Vous êtes susceptible de recevoir des offres commerciales de l'éditeur. Si vous ne le souhaitez pas,
                        veuillez cliquer sur le lien suivant : N/A.
                        <br/>
                        Vos données sont susceptibles d’être utilisées par les partenaires de l'éditeur à des fins de
                        prospection commerciale, si vous ne le souhaitez pas, veuillez cliquer sur le lien suivant : N/A.
                        <br/>
                    ...
                    <br/>
                    <br/>
                    <span class='page-subtitle strong'>Article 13 - Cookies</span>
                    <br/>
                    <br/>
                    <span class='font-underline'>Qu’est-ce qu’un « cookie » ?</span>
                    <br/>
                    <br/>
                    ...
                    <a href='https://www.cnil.fr/fr/cookies-traceurs-que-dit-la-loi'>https://www.cnil.fr/fr/cookies-traceurs-que-dit-la-loi</a>).
                    <br/>
                    <br/>
                    En naviguant sur ce site, des « cookies » émanant de la société responsable du site concerné et/ou
                    des sociétés tiers pourront être déposés sur votre terminal.
                    <br/>
                    <br/>
                    Lors de la première navigation sur ce site, une bannière explicative sur l’utilisation des « cookies
                    » apparaîtra.
                    <br/>
                    Dès lors, en poursuivant la navigation, le client et/ou prospect sera réputé informé
                    et avoir accepté l’utilisation desdits « cookies ».
                    <br/>
                    Le consentement donné sera valable pour une période de treize (13) mois.
                    <br/>
                    ...
                    <br/>
                    <br/>
                    <span class='font-underline'>Les cookies suivants sont présents sur ce site :</span>
                    <br/>
                    <br/>
                    <span class='m-2 p-2'>
                        <i class='fa fa-chevron-right'></i>
                    ...
                    <span class='m-2 p-2'>
                        <i class='fa fa-chevron-right'></i>
                        &nbsp;Ukua theme : permet l'affichage du thème choisis par l'utilisateur. (par défaut: 'light').
                    </span>
                    <br/>
                    <br/>
                    ...
                    <br/>
                    <br/>
                    <span class='page-subtitle strong'>Article 14 - Photographies et représentation des produits</span>
                    <br/>
                    <br/>
                    ...
                    <br/>
                    <br/>
                    <span class='page-subtitle strong'>Article 15 - Loi applicable</span>
                    <br/>
                    <br/>
                    ...
                    <br/>
                    <br/>
                    <span class='page-subtitle strong'>Article 16 - Contactez-nous</span>
                    <br/>
                    <br/>
                    Pour toute question, information sur les produits présentés sur le site, ou concernant le site
                    lui-même, vous pouvez laisser nous contacter au information susnommé du site, ou sur notre page de
                    contact à l'adresse suivante : <a href='https://ukua.com/contact'>https://ukua.com/contact</a>
                </p>
            </div>
        </div>
    </section>
