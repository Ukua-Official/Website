    ...
    <div class="top">
        ...
        <div class="advertissements">
            <div class="advertissements__section">
                <p class="advertissements__text">Nous travaillons actuellement sur le site Internet. Il vous est
                    néanmoins possible d'intéragir avec nous.</p>
                <div class="advertissements__list">
                    <p class="advertissements__list__item"><?php include('documents/icons/angle-right-solid.svg') ?>
                        Souscrivez à notre <a href="#">NewsLetter</a></p>
                    <p class="advertissements__list__item"><?php include('documents/icons/angle-right-solid.svg') ?>
                        Contactez-nous par <a href="mailto:contact@pyro-tech.fr">E-Mail</a></p>
                </div>
            </div>
            <div class="advertissements__section">
                <p class="advertissements__text" style="margin-bottom: 10px">Il est possible que notre maintenance dûre
                    quelques temps. Pour le moment, nous ne sommes pas en mesure de vous donner une date de
                    réouverture.</p>
